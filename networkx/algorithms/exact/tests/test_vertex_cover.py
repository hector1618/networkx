...
from  networkx.exact import exact as e
...
class TestMWVC:
    ...
    def test_min_vertex_cover(self):
        ...
        cover = e.min_weighted_vertex_cover(sg)
        ...
        cover = e.min_weighted_vertex_cover(wg, weight="weight")
...
def test_is_vertex_cover():
    G = nx.Graph()
    assert_true(is_vertex_cover(G, {}))
